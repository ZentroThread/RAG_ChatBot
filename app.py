...
#     Don't answer the questions that are not related for clothes. Those questions are answered by "It's out of my domain. Please ask questions regarding clothes in the database"
#     
#     {schema}
# 
#     for example:
